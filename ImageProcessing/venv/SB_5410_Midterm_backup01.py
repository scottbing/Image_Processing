...
class Application(Frame):
    ...
    def putImage(self, File):
        ...
        self.canvas = Canvas(self.upper, bd=0, width=self.photo.width(), height=400, xscrollcommand=self.xscroll.set, yscrollcommand=self.yscroll.set)
    ...
    def create_widgets(self):
        ...
        self.tolerance_ent = Entry(self.lower, width=8)
        ...
        self.generate_btn = Button(self.lower,
                                   text="Generate",
