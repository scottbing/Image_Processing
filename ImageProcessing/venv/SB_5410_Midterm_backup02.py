...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # self.xscroll.config(command=self.canvas.xview)
        # self.yscroll.config(command=self.canvas.yview)
        self.upper.grid(row=0, column=0, sticky=W)

        self.lower = Frame(root, bd=2, relief=SUNKEN)
        self.lower.grid(row=0, column=0, sticky=NSRW)
        ...
        self.height_ent.grid(row=0, column=1, sticky=W)
        Label(self.lower,
              text="Width:"
              ).grid(row=0, column=3, sticky=E)
        self.width_ent = Entry(self, width=10)
        self.width_ent.grid(row=0, column=4, sticky=W)
